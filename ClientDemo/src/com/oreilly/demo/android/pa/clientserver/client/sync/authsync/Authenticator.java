...
public class Authenticator extends AbstractAccountAuthenticator {
	...
	public Bundle confirmCredentials(AccountAuthenticatorResponse response,
		...
		if (options != null && options.containsKey(AccountManager.KEY_PASSWORD)) {
			...
			JSONObject json = NetworkUtil.login(
					NetworkUtil.hosturl != null ? NetworkUtil.hosturl : context
							.getString(R.string.baseurl), account.name,
					password, true, null);
	...
	public String getAuthTokenLabel(String authTokenType) {
		...
		return authTokenType.equals(AUTHTOKEN_TYPE) ? context
				.getString(R.string.authlabel) : null;
